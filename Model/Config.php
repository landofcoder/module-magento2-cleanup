...
class Config
{
    ...
    public function isEnabled()
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/general/is_enabled',
    ...
    public function getDatabasePingTime()
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/general/database_ping_time',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/files/cleanup_logfiles',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/files/keep_logfile_days',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/files/cleanup_all_files',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/files/cleanup_reports',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/files/keep_reports_days',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/files/cleanup_optional_folders_enabled',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getCleanupOptionalFolders()
    {
        $folders = $this->serializer->unserialize($this->scopeConfig->getValue(
            'lof_cleanup/files/cleanup_optional_folders',
            ScopeInterface::SCOPE_STORE
        ));
        if (!is_array($folders)) {
            $folders = [];
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/media/cleanup_media',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/quotes/cleanup_sales_quote_customers',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/quotes/keep_cart_quotes_customers_days',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/quotes/cleanup_sales_quote_guests',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/quotes/keep_cart_quotes_guests_days',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/adminnotifications/is_enabled',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return intval($this->scopeConfig->getValue(
            'lof_cleanup/adminnotifications/keep_days',
            ScopeInterface::SCOPE_STORE
        ));
    }
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'lof_cleanup/adminnotifications/delete_notifications',
            ScopeInterface::SCOPE_STORE
        );
    }
