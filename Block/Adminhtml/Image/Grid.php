...
namespace Lof\Cleanup\Block\Adminhtml\Image;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Lof\Cleanup\Model\imageFactory
     */
     ...
     * @param \Lof\Cleanup\Model\imageFactory       $imageFactory
    ...
    public function __construct(
        ...
        \Lof\Cleanup\Model\ImageFactory $ImageFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                'header' => __('Image'),
                'index' => 'value',
                'renderer' => '\Lof\Cleanup\Block\Adminhtml\Image\Grid\Renderer\Image',
            )
        );
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    'caption' => __('Delete'),
                    'url' => array('base' => 'cleanup/image/delete'),
                    'field' => 'value_id',
                ),
            ),
            'renderer' => 'Lof\Cleanup\Block\Adminhtml\Image\Grid\Renderer\Action',
            'index' => 'value_id',
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                'label' => __('Delete'),
                'url' => $this->getUrl('cleanup/*/massDelete'),
    ...
    {
        return $this->getUrl('cleanup/*/index', ['_current' => true]);
    }

    /**
     * @param \Lof\Cleanup\Model\image|\Magento\Framework\Object $row
     *
     * @return string
     */
